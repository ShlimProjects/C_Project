//////////////////////////////////////////////////////////////////////////////////////////
//
//  GetStartedUserGatesSSR.cpp: Example program for User Gated SSR on AP240 modules
//
//----------------------------------------------------------------------------------------
//
...
int main(int argc, char *argv[])
{
	...
	ViReal64 trigLevel = 0.0;			// Trigger level = +10% of FSR (i.e. + 50 mV)		
    ...
    long const nbrGates = 3;
    long const lenGate = 64;
	...
	status = AcqrsD1_configSetupArray(idInstrument, idChannel, 0, nbrGates, gateParamP);



	// Allocate buffers for readout
	long const nbrSamplePerSeg = (lenGate + 8 ) * nbrGates;
	long const nbrBytesAlloc = (nbrSamplePerSeg + 8) * nbrSegments;
