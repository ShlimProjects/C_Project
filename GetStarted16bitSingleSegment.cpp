//////////////////////////////////////////////////////////////////////////////////////////
//
//  GetStarted16bitSingleSegment.cpp : C++ demo program for Agilent Acqiris Digitizers
//----------------------------------------------------------------------------------------
...
int main (int argc, char *argv[])
{
    ...
    cout << "Agilent Acqiris - GetStarted16bitSingleSegment" << endl;
    ...
    readPar.dataArraySize = (nbrSamples + 32) * sizeof(ViInt16); // Array size in bytes
    ...
    ViInt16 * adcArrayP = new ViInt16[readPar.dataArraySize / sizeof(ViInt16)];
